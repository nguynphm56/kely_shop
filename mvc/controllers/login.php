            ...
            if(!isset($_SESSION["info"])){
                ...
                if(isset($_POST["login"])){
                    ...
                    if($check_block_user == 0){
                        ...
                        //notification("error","Đăng Nhập Thất Bại","Tài khoản bị khóa rùi, hihi, Liên hệ quản trị viên mở nhé","OK","true","#3085d6");
                        //notification("error","Đăng Nhập Thất Bại","Tài khoản đã bị khóa, liên hệ quản trị viên để mở","OK","true","#3085d6");
                        //notification("error","Đăng Nhập Thất Bại","Tài khoản bị khóa, vui lòng liên hệ quản trị viên để mở khóa","OK","true","#3085d6");
                        //notification("error","Đăng Nhập Thất Bại","Xin lỗi, tài khoản đã bị khóa, vui lòng liên hệ quản trị viên","OK","true","#3085d6");
