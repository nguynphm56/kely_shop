<?php
    // HIỆN DANH SÁCH SẢN PHẨM Ở TRANG HOME
                    ...
                    <div class="product-image-wrapper"style="max-height: 400px;">
                        <div class="single-products"style="max-height: 400px;">
                            <div class="productinfo text-center" style="max-height: 450px;">
                                <img style="max-height: 250px; max-width: 200px;min-height: 250px;object-fit: cover; border-radius: 5px" 
                                src="public/images/img_product/'.$values["img_product"].'" alt="" />
