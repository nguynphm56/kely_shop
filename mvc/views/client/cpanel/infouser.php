...
<body>
    ...
    <div id="contact-page" class="container">
        <h3 style="color: #262626; font-size: 40px;text-align: center;">Thông Tin Cá Nhân</h3>
    		...
    		<div class="row" style="margin-top: 36px;">  	
	    		<div class="col-sm-7">
	    			<div class="contact-form">
	    				<h2 class="title text-center" style="color: #262626; font-size: 24px;">Thay Đổi Thông Tin Cá Nhân</h2>
	    		...
	    		<div class="col-sm-5">
					<form id="main-contact-form" class="contact-form row" name="contact-form" method="post">
						<div class="contact-info">
							<h2 class="title text-center" style="color: #262626; font-size: 24px;">Thay Đổi Mật Khẩu</h2>
